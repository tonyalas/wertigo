...
function BusinessOfTheWeek() {
    ...
    return (
        <>
            ...
            <p className='center'>
                {thisWeekBusiness.name} specializes in bringing the best available fresh produce and goods to their local neighbourhood.<br></br> They have just recently celebrated <b>4</b> years of being open!<br></br>Click the button below for more information.
            </p>
